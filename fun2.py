...
def pVc(power, current):
    ...
    # plt.show()
    plt.savefig('powerVscurrent.jpg')
...
response = requests.get(
    'https://api.thingspeak.com/channels/1595621/feeds.json?results=100').json()
data = response['feeds']
# print(data)
power = []
current = []
